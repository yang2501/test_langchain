...
class AzureOpenAISetup:
    def __init__(self):
        load_dotenv()
        self.tenant_id = st.secrets["tenant_id"] # os.environ.get("tenant_id")
        self.client_id = st.secrets["client_id"] #os.environ.get("client_id")
        self.client_secret = st.secrets["client_secret"] # os.environ.get("client_secret")
        self.refresh_token()
